...
<body class="childrenBody">
		...
		<blockquote class="layui-elem-quote news_search">
			<form id="form1" class="layui-form" method="post" action="AdminopLogServlet?op=loglist">
	...
	layui.use(['form','layer','laydate'],function(){
		...
		$("#reset").click(function(){
			...
			window.location.href="AdminopLogServlet?op=loglist&pageSize="+pageSize+"&currentPage=1";
		});
	</script>
</body>
</html>