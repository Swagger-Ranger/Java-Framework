...
<body class="childrenBody">
	<form class="layui-form" method="post" action="www.baidu.com">
		<input type="hidden" value="" lay-verify="required" class="layui-input robotId">
		<div class="user_left">
			<div class="layui-form-item">
			    <label class="layui-form-label">机器人账号</label>
			    <div class="layui-input-block">
			    	<input type="text" value="" disabled="disabled" placeholder="请输入机器人账号" lay-verify="required" class="layui-input account">
			    </div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			    	<textarea placeholder="请输入内容" value="" name="autograph" class="layui-textarea myself"></textarea>
			    </div>
			</div>
		</div>
	...
	<script type="text/javascript" src="js/editrobot.js"></script>
</body>
</html>