...
<base href="<%=basePath%>">
	...
	<SCRIPT type="text/javascript">
		...
		var zNodes =[
			...
			{ id:2, pId:0, name:"用户管理", open:false},
				{ id:5, pId:2, name:"用户"},
					...
					/* 开启后台充值信息功能        2018-4-26  14:37     zhanglei    begin*/
					{ id:502, pId:5, name:"充值"},
            		/*开启后台充值信息功能        2018-4-26  14:37     zhanglei    end*/
				{ id:8, pId:2, name:"推广员"},
			...
			<%-- 开启后台充值信息功能        2018-4-25  14:06     zhanglei    begin--%>
					{ id:16, pId:13, name:"后台充值信息"}
            <%-- 开启后台充值信息功能        2018-4-25  14:06     zhanglei    end--%>
		];
		...
		function setCheck() {
			...
			/*type =  { "Y" : "ps", "N" : "s" };*/
			type =  { "Y" : "ps", "N" : "ps" };//2018-4-12 13:40 by lujun 修复父子级联动
	...
	<div class="user_left">
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input name="name" id="aname" lay-verify="required|name" autocomplete="off" placeholder="请输入管理员账号" class="layui-input" type="text">
		    </div>
		  </div>
		  <div class="layui-form-item">
