var $,tab,skyconsWeather,indexload,layer;
layui.config({
	base : "js/"
	...
	$("body").on("click","#unlock",function(){
		if($(this).siblings(".admin-header-lock-input").val() == ''){
			...
			$.post("AdminServlet",{"op":"isPwd","pwd":$(this).siblings(".admin-header-lock-input").val()},function(e){
				if(e=="ok"){
			...
			/*if($(this).siblings(".admin-header-lock-input").val() == ss){
	...
	$("body").on("click",".layui-nav .layui-nav-item a",function(){
		...
		if($(this).parent().prop("className")=="layui-nav-item2"){
			$(this).parent().addClass("layui-nav-itemed2");
		}else if($(this).parent().prop("className")=="layui-nav-item2 layui-nav-itemed2"){
			$(this).parent().removeClass("layui-nav-itemed2");
		}
		$(this).parent("li").siblings().removeClass("layui-nav-itemed");
		$(this).parent("li").siblings().removeClass("layui-nav-itemed2");
	});
...
function addTab(_this){
	var name2 = $(_this).children("cite").html();
	var flg = true;
	if(typeof(name2) == "undefined"){
		flg=false;
	}
	if(name2 == "锁屏" || name2 == "更换皮肤"){
		flg=false;
	}
	var id = $("#top_tabs").children("li");
	$(id).each(function(){
	    var name = $(this).children("cite").html();
	    if(name==name2){
	    	flg =false;
	    }
	 });
